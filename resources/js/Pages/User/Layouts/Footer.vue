<template>
     <footer
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/"
                class="hover:underline">PCNubbies™</a>. All Rights Reserved.
        </span>
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Facebook link</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Twitter Link</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Company Link</a>
            </li>
            <li>
