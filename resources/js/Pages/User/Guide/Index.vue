<template>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">How to Choose what parts</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Choose one of the following and get a recommendation guide on what parts to buy!</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <a href="gamer" class="block transform hover:scale-105 hover:shadow-2xl transition-all duration-500 ease-in-out text-center">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-gray-700 text-base">Planning to build computer entirely for gaming for faster and immersive gaming experience.</p>
                        <button class="mt-4 bg-gradient-to-r from-purple-700 to-rose-700 hover:bg-gradient-to-l hover:from-purple-950 hover:to-rose-950 text-white font-bold py-2 px-4 rounded">
                            Read More
                        </button>
                    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Steps on how to build</h2>
                <p class="text-gray-500 sm:text-xl dark:text-gray-400">Choose one of the following and get a recommendation guide on what parts to buy!</p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <!-- Article 1 -->
                <article class="transform hover:scale-105 hover:shadow-2xl transition-all duration-500 ease-in-out text-center">
                    <a href="#" class="block">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png" class="mb-5 rounded-lg w-full h-64 object-cover" alt="Image 2">
                        <div class="px-6 py-4">
                ...
                <article class="transform hover:scale-105 hover:shadow-2xl transition-all duration-500 ease-in-out text-center">
                    <a href="#" class="block">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png" class="mb-5 rounded-lg w-full h-64 object-cover" alt="Image 2">
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">DDR4 Computers</div>
                            <button class="mt-4 bg-gradient-to-r from-purple-700 to-rose-700 hover:bg-gradient-to-l hover:from-purple-950 hover:to-rose-950 text-white font-bold py-2 px-4 rounded">
                                Read More
                            </button>
                        </div>
                ...
                <article class="transform hover:scale-105 hover:shadow-2xl transition-all duration-500 ease-in-out text-center">
                    <a href="#" class="block">
                        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png" class="mb-5 rounded-lg w-full h-64 object-cover" alt="Image 2">
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">DDR5 Computers</div>
                            <button class="mt-4 bg-gradient-to-r from-purple-700 to-rose-700 hover:bg-gradient-to-l hover:from-purple-950 hover:to-rose-950 text-white font-bold py-2 px-4 rounded">
                                Read More
                            </button>
                        </div>
    ...
    <section class="bg-white dark:bg-gray-900 mt-16">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <!-- Article 1 -->
                <a href="casual" class="block transform hover:scale-105 hover:shadow-2xl transition-all duration-500 ease-in-out">
                    <img class="w-full h-64 object-cover" src="https://www.shutterstock.com/image-photo/young-business-man-sitting-desk-600nw-129114017.jpg" alt="Sunshine">
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Casual User/Beginner</div>
                        <p class="text-gray-700 text-base">Someone who has 0 experience and workaround with computers but wanting to build one.</p>
