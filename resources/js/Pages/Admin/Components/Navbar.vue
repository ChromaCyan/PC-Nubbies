                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base text-red-500 list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-white-600 rounded-xl" id="apps-dropdown">
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <Link :href="route('admin.products.index')" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">Product Listing</div>
                        </Link>
                        <Link :href="route('admin.users.index')" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                            <svg aria-hidden="true" class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
