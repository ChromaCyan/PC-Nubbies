<template>
    <nav class="bg-purple-500 border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">PCNubbies</span>
                </a>
            </div>
            <div class="flex items-center lg:order-2">
                ...
                <!-- Dropdown menu -->
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base text-red-500 list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-white-600 rounded-xl" id="apps-dropdown">

                    <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-white-600 dark:text-gray-300">
                        Apps
                    </div>
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">Product Management</div>
                        </a>
                        <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                            <svg aria-hidden="true" class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    ...
                    <img class="w-8 h-8 rounded-full" src="https://i.pinimg.com/736x/71/de/f7/71def7565752706923db63068edb9e13.jpg" />
                </button>
                <!-- Dropdown menu -->
